...
func wander(_ gc: CGContext) {
  ...
  let maxOffset = Int.random(in: 5...20)
...
//      solid = true
    ...
    let rectW = CGFloat.random(in: 3...15)
    let rectH = CGFloat.random(in: 3...15)
